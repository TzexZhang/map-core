 ...
 */
export declare function assertNonEmptyString(value: unknown, paramName: string): void;
/**
 * 校验数值范围
 ...
 */
export declare function assertDefined(value: unknown, paramName: string): void;
/**
 * 校验 ID 唯一性
 ...
 */
export declare function assertValidLngLat(lngLat: unknown, paramName: string): void;
/**
 * 校验 DOM 容器元素有效性
