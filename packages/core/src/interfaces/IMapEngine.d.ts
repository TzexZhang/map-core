 ...
 */
import type { LngLat, PixelCoord, BoundingBox, ViewState, FlyToOptions, MapCoreOptions, QueryOptions, GeoJSONFeatureCollection, GeoJSONFeature, LayerConfig } from '../types';
/**
 * 地图引擎统一抽象接口
