 ...
 */
export type LayerConfig = TileLayerConfig | VectorLayerConfig | WMSLayerConfig | WMTSLayerConfig | HeatmapLayerConfig | Tileset3DLayerConfig | TerrainLayerConfig | CZMLLayerConfig | CustomLayerConfig;
/**
 * 图层运行时状态
